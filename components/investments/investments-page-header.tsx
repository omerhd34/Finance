    ...
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <div>
        <p className="max-w-5xl text-pretty text-sm text-muted-foreground">
          Altın, emtia, döviz, hisse ve kripto pozisyonlarınızı
          tek ekrandan takip edin. Güncel birim fiyatlar mümkün olduğunda
          otomatik gelir; canlı veri yoksa önce kayıtlı piyasa fiyatınız, o da
          yoksa alış fiyatınız kullanılır. Kripto kotasyonları USD üzerinden
          USD/TRY ile TL hesaplanır. Emtiada çoğu uluslararası kotasyon USD→TL
          çevrilir; GRPLTN gibi gram bazlı Türkiye kotasyonları kaynakta zaten
          TL olarak gelir.
        </p>
      </div>
      <NewPositionDialog
