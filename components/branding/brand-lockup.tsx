...
> = {
  landing: {
    wrapper: "gap-3 group cursor-pointer",
    iconWrap:
      "relative overflow-hidden rounded-xl ring-1 ring-emerald-500/20 bg-white/50 shadow-sm transition-all duration-500 group-hover:ring-emerald-500/50 group-hover:shadow-lg group-hover:shadow-emerald-500/20 dark:bg-white/5 dark:ring-emerald-400/20 dark:group-hover:ring-emerald-400/40",
    icon: "h-11 w-11 object-cover transition-transform duration-500 group-hover:scale-110",
    textWrap:
      "inline-flex items-baseline text-2xl font-bold tracking-tight antialiased",
